...
Route::group(['middleware' => ['web', 'auth', 'roles'], 'roles' => ['admin','ithead'], 'prefix' => \Helper::getSubdirectory(), 'namespace' => 'Modules\CustomFields\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['web', 'auth', 'roles'], 'roles' => ['user', 'admin','ithead'], 'prefix' => \Helper::getSubdirectory(), 'namespace' => 'Modules\CustomFields\Http\Controllers'], function()
{
